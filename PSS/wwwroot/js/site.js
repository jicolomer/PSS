            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response === "Save") {
                        ...
                        $('#mensajenuevo').html("No sse puede guardar el usuario. <br/>Seleccione un rol. <br/> Ingrese un email correcto. <br/> El password debe tener de 6-100 caracteres, al menos un caracter especial, una letra mayúscula y un número");
                    }
                }
            });
        }
