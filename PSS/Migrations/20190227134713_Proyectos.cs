        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutorProyecto = table.Column<string>(nullable: true),
                    CaracteristicasTerreno = table.Column<string>(nullable: true),
                    CirculacionesPeatonales = table.Column<bool>(nullable: false),
                    CiudadContratista = table.Column<string>(nullable: true),
                    CiudadObra = table.Column<string>(nullable: true),
                    Cliente = table.Column<string>(nullable: true),
                    Climatologia = table.Column<string>(nullable: true),
                    ConduccionesGas = table.Column<bool>(nullable: false),
                    Contratista = table.Column<string>(nullable: true),
                    CpContratista = table.Column<string>(nullable: true),
                    CpObra = table.Column<string>(nullable: true),
                    CssfaseProyecto = table.Column<string>(nullable: true),
                    DescripcionLugar = table.Column<string>(nullable: true),
                    DescripcionObra = table.Column<string>(nullable: true),
                    DireccionContratista = table.Column<string>(nullable: true),
                    DireccionObra = table.Column<string>(nullable: true),
                    ...
                    JefeObra = table.Column<string>(nullable: true),
                    LinElectAereas = table.Column<bool>(nullable: false),
                    LinElectEnterradas = table.Column<bool>(nullable: false),
                    LinderoEste = table.Column<string>(nullable: true),
                    LinderoNorte = table.Column<string>(nullable: true),
                    LinderoOeste = table.Column<string>(nullable: true),
                    LinderoSur = table.Column<string>(nullable: true),
                    LineasTelefonicas = table.Column<bool>(nullable: false),
                    NombreObra = table.Column<string>(nullable: true),
                    NumOt = table.Column<string>(nullable: true),
                    NumTrabajadores = table.Column<int>(nullable: true),
                    PemPec = table.Column<string>(nullable: true),
                    Presupuesto = table.Column<decimal>(nullable: true),
                    Promotor = table.Column<string>(nullable: true),
                    ProvinciaContratista = table.Column<string>(nullable: true),
                    ProvinciaObra = table.Column<string>(nullable: true),
                    RecursoPreventivo = table.Column<string>(nullable: true),
                    Superficie = table.Column<string>(nullable: true),
                    Tecnico = table.Column<string>(nullable: true),
                    TipoEstudio = table.Column<string>(nullable: true),
                    TipoObra = table.Column<string>(nullable: true),
                    TraficoRodado = table.Column<string>(nullable: true),
                    Transformadores = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Proyectos", x => x.IdObra);
                });
